...
namespace MSNStocks.Models.xml6
{
    ...
    public class InBseFinDescriptionOfSingleSegment
    {
        [JsonProperty("@contextRef")]
        public string contextRef { get; set; }
    ...
    public class FinancialsResultsFromXml6
    {
        [JsonProperty("?xml")]
    ...
    public class XbrliXbrl
    {
        ...
        [JsonProperty("in-bse-fin:DescriptionOfSingleSegment")]
        public InBseFinDescriptionOfSingleSegment inbsefinDescriptionOfSingleSegment { get; set; }
